var note = (function() {
  ...
  var HttpClient = function() {
      ...
      this.delete = function (aUrl, id, aCallback) {
          var httpRequest = new XMLHttpRequest();
          httpRequest.onreadystatechange = function() {
              if (httpRequest.readyState == 4 && httpRequest.status == 200)
                  aCallback(httpRequest.responseText);
          ...
          httpRequest.open( "DELETE", aUrl, true );
          httpRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
          httpRequest.send( "id=" + id + '_method=delete');
      }
  };
  ...
  return {
    ...
    deleteOne: function (id, callback) {
      http.delete('http://localhost:4567/notes/', id, function (response) {
      })
      ;
    }
  };
